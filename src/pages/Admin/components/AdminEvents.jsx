...
const AdminEvents = ({ e, onDelete }) => {
  ...
  return (
    <div className="rounded-2xl mt-20 overflow-hidden shadow-lg bg-white transition-all duration-300 hover:shadow-2xl relative">
...
export default function EventList() {
  ...
  return (
    <div className="px-4 md:px-50 lg:px-70 py-25">
      {/* Filter + Arrows */}
